...
public class CreateEventActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTxtStartDate = (TextView) findViewById(R.id.create_event_tv_start_date_value);
        mTxtEndDate = (TextView) findViewById(R.id.create_event_tv_end_date_value);
        mTxtStartTime = (TextView) findViewById(R.id.create_event_tv_start_time_value);
        mTxtEndTime = (TextView) findViewById(R.id.create_event_tv_end_time_value);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.create_event_tv_start_date_value) {
        ...
        } else if (id == R.id.create_event_tv_end_date_value) {
            mDatePickerDialogFragment.setFlag(DatePickerDialogFragment.FLAG_END_DATE);
            mDatePickerDialogFragment.show(getSupportFragmentManager(), "datePicker");
        } else if (id == R.id.create_event_tv_start_time_value) {
        ...
        } else if (id == R.id.create_event_tv_end_time_value) {
